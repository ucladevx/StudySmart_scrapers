...
"""
TODO: 
- move credentials to other file and add it to gitignore
- split date into start and end time 
"""
...
def main(event=None, lambda_context=None): 
    ...
    try:
        conn = psycopg2.connect(host='studysmart-db.chpjzhfmtelr.us-west-1.rds.amazonaws.com',
                                port='5432',
                                database='mydb',
                                user='studyroot',
